...
try:
    ...
    bigquery_types_tuple = None  # type: ignore
    BIGQUERY_TYPES = {
    ...
    try:
        ...
        try:
            ...
            bigquery_types_tuple = {}  # type: ignore
            BIGQUERY_TYPES = {
                "INTEGER": sqla_bigquery.INTEGER,
                "NUMERIC": sqla_bigquery.NUMERIC,
                "STRING": sqla_bigquery.STRING,
            ...
            BigQueryTypes = namedtuple("BigQueryTypes", sorted(sqla_bigquery._type_map))  # type: ignore
            bigquery_types_tuple = BigQueryTypes(**sqla_bigquery._type_map)  # type: ignore
            BIGQUERY_TYPES = {}
